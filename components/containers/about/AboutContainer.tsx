...
export default function AboutContainer({ messages }: AboutContainerProps) {
  return (
    <section className={styles['about']} aria-labelledby="about-title">
      <h1 id="about-title" className={styles['about__title']}>
        {messages.title}
      </h1>
      ...
      <div className={styles['about__grid']}>
        <div className={styles['about__card']}>
          <h2 className={styles['about__card-title']}>{messages.missionTitle}</h2>
          <p>{messages.missionDescription}</p>
        </div>
        <div className={styles['about__card']}>
          <h2 className={styles['about__card-title']}>{messages.visionTitle}</h2>
